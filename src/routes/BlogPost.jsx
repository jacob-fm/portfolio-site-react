  ...
  if (!post) {
    return (
      <div className="max-w-200 mx-auto text-center mt-20">
        ...
        <Link
          to="/blog"
          className="w-min mx-auto flex items-center justify-center gap-1.5 py-2 px-4 text-lg text-primary border border-primary rounded-lg hover:text-hover hover:border-hover active:text-blue-700 active:border-blue-700"
        >
